		      	...
		      	<div class="row">
					...
					<div class="col-12 col-md-4 col-lg-3 mb-5">
						<a class="product-item" href="#">
							...
							<h3 class="product-title">Curso Integrador I</h3>
					...
					<div class="col-12 col-md-4 col-lg-3 mb-5">
						<a class="product-item" href="#">
							...
							<h3 class="product-title">Redes y Comunicaciones II</h3>
					...
					<div class="col-12 col-md-4 col-lg-3 mb-5">
						<a class="product-item" href="#">
							...
							<h3 class="product-title">Inglés IV</h3>
							<strong class="product-price">Semana 7</strong>
					...
					<div class="col-12 col-md-4 col-lg-3 mb-5">
						<a class="product-item" href="#">
							...
							<h3 class="product-title">Analisis y Diseño</h3>
							<strong class="product-price">Semana 7</strong>
					...
					<div class="col-12 col-md-4 col-lg-3 mb-5">
						<a class="product-item" href="#">
							<img src="images/investigacion.png" class="img-fluid product-thumbnail">
							<h3 class="product-title">Investigación Operativa</h3>
							<strong class="product-price">Semana 6</strong>
					...
					<div class="col-12 col-md-4 col-lg-3 mb-5">
						<a class="product-item" href="#">
							<img src="images/desarrollo-web.png" class="img-fluid product-thumbnail">
							<h3 class="product-title">Desarrollo Web Integrado</h3>
							<strong class="product-price">Semana 7</strong>
