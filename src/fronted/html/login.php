          ...
          <div class="row g-0">
                ...
                <form>
                  ...
                  <div data-mdb-input-init class="form-outline mb-4">
                    <input type="email" id="form2Example11" class="form-control"
                      placeholder="Aquí ingresa tu correo @utp.edu.pe" />
                  ...
                  <div class="text-center pt-1 mb-5 pb-1">
                    <button data-mdb-button-init data-mdb-ripple-init class="btn btn-primary btn-block fa-lg gradient-custom-2 mb-3" type="button" href="index.php">
						Ingresar</button>
            ...
            <div class="col-lg-6 d-flex align-items-center gradient-custom-2">
              <div class="text-white px-3 py-4 p-md-5 mx-md-4">
                ...
                <p class="small mb-0">Nos adaptamos a ti, que nada te detenga, revisa tus modulos donde te quedaste, completa tus tareas importantes y no te pierdas de nada.</p>
              </div>
            </div>
          </div>
        </div>
