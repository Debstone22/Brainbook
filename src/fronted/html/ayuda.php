		...
		<!-- Start Hero Section -->
			<div class="hero">
                ...
                <h1></h1>
								...
								<p class="mb-4">Podrás visualizar contenidos que pueden ser de utilidad para entender mejor el aprendizaje virtual. </p>
								<p><a href="https://api.whatsapp.com/send?phone=51960252970&text=Hola,%20tengo%20una%20consulta" class="btn btn-secondary me-2" target="_blank">SAE</a><a href="https://www.youtube.com/watch?v=sjOZK783B1g" class="btn btn-white-outline"target="_blank">Demo</a></p>
							</div>
						</div>
						<div class="col-lg-7">
