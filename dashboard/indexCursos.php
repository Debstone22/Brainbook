                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="table-wrapper">
                            ...
                            // Consulta SQL con límite y offset para la paginación
                            $consulta = "SELECT cursos.id_curso, cursos.nombre_curso, cursos.descripcion, cursos.status, cursos.version, cursos.imagen, 
            (SELECT COUNT(*) FROM curso_estudiante WHERE curso_estudiante.id_curso = cursos.id_curso) AS usuarios_inscritos 
            FROM cursos LIMIT :offset, :registros_por_pagina";
                            ...
                            // Se obtiene el número total de registros
                            ...
                            <table class="table table-striped table-hover">
                                ...
                                <tbody id="courseTable">
                                    ...
                                    <tr>
                                        <td>
                                            <?php echo htmlspecialchars($fila['id_curso']); ?>
                                        </td>
                                        <td>
                                            <?php echo htmlspecialchars($fila['nombre_curso']); ?>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <?php echo htmlspecialchars($fila['version']); ?>
                                        </td>
                                        <td>
                                            <?php if (!empty($fila['imagen'])) { ?>
                                            <img src="<?php echo htmlspecialchars($fila['imagen']); ?>"
                                                alt="Imagen del Curso" width="50" height="50" class="img-thumbnail"
                                                data-toggle="modal" data-target="#imageModal"
                                                data-src="<?php echo htmlspecialchars($fila['imagen']); ?>">
                                            <?php } else { ?>
                                            No hay imagen
                                            <?php } ?>
                                        </td>
                                        <td align="center">
                                            <!-- Botones de editar y eliminar -->
                                                <a class="edit" href="#editCourseModal" data-toggle="modal"
                                                ...
                                                <a class="delete" href="#deleteCourseModal" data-toggle="modal"
                                                    data-id="<?php echo htmlspecialchars($fila['id_curso']); ?>">
                                                    <i class="material-icons" data-toggle="tooltip"
                                                        title="Delete">&#xE872;</i>
                                                </a>
